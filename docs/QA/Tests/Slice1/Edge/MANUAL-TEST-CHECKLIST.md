...
- [PENDING MANUAL CHECK] Delete-layer and bring-forward/send-backward checks in Section 4 were left unexecuted in the original Edge run and still need a manual browser pass to close out Slice1 cleanly.
