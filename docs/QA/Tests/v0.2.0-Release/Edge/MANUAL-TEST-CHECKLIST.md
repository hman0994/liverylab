# Livery Lab v0.2.0 Release QA Checklist — Edge

This checklist validates the v0.2.0 release (Architecture Migration Complete) in Edge.
...
- [] Confirm the header logo, version badge (`v0.2.0`), toolbar, right panel, and footer controls are visible.
